...
const int NOTES_IN_ROW = 2;
const int NOTES_IN_COLUMN = 4;
const Scalar NOTE_COLORS[] = {
    Scalar(0,0,0,128),
    Scalar(255,0,0,128),
    Scalar(0,255,0,128),
    Scalar(0,0,255,128),
    Scalar(255,255,255,128),
    Scalar(255,255,0,128),
    Scalar(0,255,255,128),
    Scalar(255,0,255,128),
};
Mat image;
